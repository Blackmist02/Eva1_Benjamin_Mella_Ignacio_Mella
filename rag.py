    ...
    return [
        {
            ...
            "expected_context": "síntomas diabetes tipo 2",
            "ground_truth": "Los síntomas incluyen sed excesiva, micción frecuente, fatiga, visión borrosa y cicatrización lenta de heridas."
        },
        {
            "query": "¿Qué es la hipertensión arterial?",
            "expected_context": "definición hipertensión",
            "ground_truth": "La hipertensión arterial es una condición donde la presión sanguínea en las arterias es persistentemente elevada."
        },
        {
            "query": "¿Cómo se trata la anemia?",
            "expected_context": "tratamiento anemia",
            "ground_truth": "El tratamiento depende de la causa, pero puede incluir suplementos de hierro, cambios dietéticos o tratamiento de condiciones subyacentes."
        },
        {
            "query": "¿Para qué sirven los antibióticos?",
            "expected_context": "uso antibióticos",
            "ground_truth": "Los antibióticos se utilizan para tratar infecciones bacterianas, pero no son efectivos contra virus."
        },
        {
            "query": "¿Qué síntomas tiene un infarto de miocardio?",
            "expected_context": "síntomas infarto",
            "ground_truth": "Los síntomas incluyen dolor en el pecho, dificultad para respirar, náuseas y sudoración."
        }
    ]
...
def main():
    ...
    if "eval_rag" not in st.session_state:
        st.session_state.eval_rag = {
            'documents': [
            "La diabetes tipo 2 es una enfermedad crónica que afecta la forma en que el cuerpo procesa el azúcar en la sangre. Los síntomas incluyen sed excesiva, micción frecuente, fatiga, visión borrosa y cicatrización lenta de heridas.",
            "La hipertensión arterial es una condición médica en la que la presión sanguínea en las arterias es persistentemente elevada. Se considera un factor de riesgo importante para enfermedades cardiovasculares y accidentes cerebrovasculares.",
            "La anemia es una condición caracterizada por la falta de glóbulos rojos sanos o hemoglobina suficiente para transportar oxígeno a los tejidos del cuerpo. Puede causar fatiga, debilidad, piel pálida y dificultad para respirar.",
            "Los antibióticos son medicamentos utilizados para tratar infecciones bacterianas. No son efectivos contra virus como el resfriado común o la gripe. Su uso inadecuado puede llevar al desarrollo de resistencia bacteriana.",
            "La vacunación es una de las medidas preventivas más importantes en medicina. Las vacunas estimulan el sistema inmunológico para desarrollar inmunidad contra enfermedades específicas sin causar la enfermedad.",
            "El infarto de miocardio, comúnmente conocido como ataque cardíaco, ocurre cuando el flujo sanguíneo hacia una parte del músculo cardíaco se bloquea. Los síntomas incluyen dolor en el pecho, dificultad para respirar y náuseas.",
            "La neumonía es una infección que inflama los sacos de aire en uno o ambos pulmones. Puede ser causada por bacterias, virus u hongos. Los síntomas incluyen tos con flema, fiebre, escalofríos y dificultad para respirar.",
            "La depresión es un trastorno del estado de ánimo que causa sentimientos persistentes de tristeza y pérdida de interés. Afecta cómo una persona se siente, piensa y maneja las actividades diarias."
        ],
            'embeddings': None,
